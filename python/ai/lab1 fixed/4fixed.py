"""
Описание:
Программа получает на ввод список предметов и список их количества в том же порядке. Сначало находит индекс предмета в списке предметов, 
а потом в списке количества 
"""
