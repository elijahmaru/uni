"""
Описание:
Программа принимает фразу и находит самую часто встречающиюся букву. Сначало она проходит по всей фразу и находит 
сколько раз какая буква встречается и сохраняет это в словарь, а потом проходится по словарю и находит наибольшие значение и ассоциированный 
с ней ключ(букву)
"""
